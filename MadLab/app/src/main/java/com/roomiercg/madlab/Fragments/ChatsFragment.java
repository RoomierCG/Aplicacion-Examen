...
public class ChatsFragment extends Fragment {
    ...
    private List<String> usersLst;

    /*
        La principal funcion de esta clase es carga en el ChatsFragments a todos aquellos usuarios
        con los cuales hayas enviado un mensaje
     */
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (chat.getSender().equals(firebaseUser.getUid())) {
                        usersLst.add(chat.getReciever());
                    }
                    if (chat.getReciever().equals(firebaseUser.getUid())) {
                        usersLst.add(chat.getSender());
                    }
                }
                readChats();
            }
